...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
            prog=prog,
            description=f"{prog} - project manager")
    ...
    install_parser = subparsers.add_parser("install", help="install this project")

    # TODO: add necessary arguments
    install_parser.add_argument("--root", help="directory to install project into")
